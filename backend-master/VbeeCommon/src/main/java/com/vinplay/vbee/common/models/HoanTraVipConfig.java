...
public class HoanTraVipConfig {
    ...
    static {
        try {
            ...
            String EXP_VIP_STR = (String)map.get((Object)"EXP_VIP");
            String HOAN_TRA_SPORT_STR = (String)map.get((Object)"HOAN_TRA_SPORT");
            String HOAN_TRA_CASINO_STR = (String)map.get((Object)"HOAN_TRA_CASINO");
            String HOAN_TRA_EGAME_STR = (String)map.get((Object)"HOAN_TRA_EGAME");
            int i = 0;
            int j = 0;
            int k = 0;
            int l = 0;
