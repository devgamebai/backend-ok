...
public class AgentCommissionDaily {
    ...
    private List<AgentDistribution> distributions;
    private Map<String, GameDetail> gameDetails;
    private Date createTime;

    public AgentCommissionDaily() {
    }

    public AgentCommissionDaily(String date, String userNickname, double userCommissionRate, String referralCode, long totalBet, long totalBetCasino, long totalBetSport, long totalBetGame, long userCommission, List<AgentDistribution> distributions, Date createTime) {
        this.date = date;
    ...
    public static class GameDetail {
        ...
        public GameDetail(int gameId, String gameName, long betAmount, double userRate, long userCommission, List<AgentDistribution> agentDistributions) {
            this.gameId = gameId;
        ...
        public List<AgentDistribution> getAgentDistributions() {
            return this.agentDistributions;
        }

        public void setAgentDistributions(List<AgentDistribution> agentDistributions) {
            this.agentDistributions = agentDistributions;
        }
    }
}
