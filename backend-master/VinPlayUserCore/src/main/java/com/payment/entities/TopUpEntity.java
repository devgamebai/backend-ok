...
public class TopUpEntity {
    ...
    public TopUpEntity() {
        this.initialize(new Date(), null);
    }

    public TopUpEntity(String request_id) {
        this.initialize(new Date(), request_id);
    }

    private void initialize(Date date, String request_id) {
