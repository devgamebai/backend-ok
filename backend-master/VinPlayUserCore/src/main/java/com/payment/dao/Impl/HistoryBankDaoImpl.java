...
public class HistoryBankDaoImpl
implements HistoryBankDao {
    /*
     * Exception decompiling
     */
    @Override
    public boolean create(HistoryBankEntity entity) throws SQLException {
        /*
     ...
     */
    @Override
    public HistoryBankEntity getByRequestId(String requestId) throws SQLException {
        /*
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
         * 
         * org.benf.cfr.reader.util.ConfusedCFRException: Started 2 blocks at once
    ...
    @Override
    public List<HistoryBankEntity> getAllByNickname(String nickname) throws SQLException {
        String sql = "SELECT * FROM history_bank WHERE nick_name = ? ORDER BY time DESC";
        ArrayList<HistoryBankEntity> list = new ArrayList<HistoryBankEntity>();
        try (Connection conn = ConnectionPool.getInstance().getConnection("mysqlpoolname");
             PreparedStatement stm = conn.prepareStatement(sql);){
            stm.setString(1, nickname);
            ResultSet rs = stm.executeQuery();
            while (rs.next()) {
                HistoryBankEntity entity = new HistoryBankEntity();
