...
implements BaseProcessor<HttpServletRequest, String> {
    public String execute(Param<HttpServletRequest> param) {
        ...
        if (money < 10000L) {
            return BaseResponse.error((String)"5", (String)"S\u1ed1 ti\u1ec1n n\u1ea1p t\u1ed1i thi\u1ec3u l\u00e0 10k");
        }
        String remoteAddr = request.getRemoteAddr();
        ShotFishUtils.LoginGame((String)nickname, (String)accessToken, (String)remoteAddr, (Long)0L).toJson();
        return ShotFishUtils.Deposit((String)nickname, (String)accessToken, (Long)money).toJson();
    }
}
