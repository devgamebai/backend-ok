 ...
 *  com.payment.core.hook.NoHookRegistered
 *  com.payment.core.hook.NoWhitelistRegistered
...
import com.payment.core.hook.NoHookRegistered;
import com.payment.core.hook.NoWhitelistRegistered;
...
extends HttpServlet {
    ...
    private void onExecute(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            String responseString = (String)this.hookController.processHook(request.getPathInfo(), remoteAddr, param);
