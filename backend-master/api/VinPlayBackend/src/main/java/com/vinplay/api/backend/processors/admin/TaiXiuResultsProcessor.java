...
public class TaiXiuResultsProcessor implements BaseProcessor<HttpServletRequest, String> {
    ...
    public String execute(Param<HttpServletRequest> param) {
        ...
        try {
            ...
            try (Connection conn = ConnectionPool.getInstance().getConnection("mysqlpool_minigame")) {
                int total = 0;
                try (PreparedStatement countPs = conn.prepareStatement("SELECT COUNT(*) FROM result_tai_xiu" + where.toString())) {
                ...
                String sql = "SELECT * FROM result_tai_xiu" + where.toString() + " ORDER BY id DESC LIMIT ?,?";
            ...
            logger.error("TaiXiuResultsProcessor error", e);
