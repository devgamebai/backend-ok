...
public class ListActionLogsProcessor implements BaseProcessor<HttpServletRequest, String> {
    ...
    public String execute(Param<HttpServletRequest> param) {
        ...
        try {
            ...
            try (Connection conn = ConnectionPool.getInstance().getConnection("mysqlpool_admin")) {
                // Count
                int total = 0;
                try (PreparedStatement countPs = conn.prepareStatement("SELECT COUNT(*) FROM log_admin" + where.toString())) {
                ...
                String sql = "SELECT * FROM log_admin" + where.toString() + " ORDER BY id DESC LIMIT ?,?";
            ...
            logger.error("ListActionLogsProcessor error", e);
