...
public class ListGroupsProcessor implements BaseProcessor<HttpServletRequest, String> {
    ...
    public String execute(Param<HttpServletRequest> param) {
        ...
        try {
            try (Connection conn = ConnectionPool.getInstance().getConnection("mysqlpool_admin")) {
                ...
                String sql = "SELECT * FROM groupuser ORDER BY Id";
            ...
            logger.error("ListGroupsProcessor error", e);
