    ...
    public String execute(Param<HttpServletRequest> param) {
        ...
        try {
            ...
            try (Connection conn = ConnectionPool.getInstance().getConnection("mysqlpoolname")) {
                // Count
                int total = 0;
                try (PreparedStatement ps = conn.prepareStatement("SELECT COUNT(*) FROM log_hoan_tra_histories" + where)) {
                ...
                String dataSql = "SELECT id, nick_name, time, vip_point, " +
                        ...
                        "FROM log_hoan_tra_histories" + where + " ORDER BY id DESC LIMIT ? OFFSET ?";
            ...
            logger.error("GetDataHoanTraHistoriesProcessor error", e);
