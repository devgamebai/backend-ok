...
implements BaseProcessor<HttpServletRequest, String> {
    ...
    public String execute(Param<HttpServletRequest> param) {
        ...
        try {
            ...
            // SUN: compute real pagination against the live MD5 table.
            // Previously hardcoded totalRecord=1000, totalPages=20 which capped
            // the admin UI at 20 pages regardless of actual data size.
