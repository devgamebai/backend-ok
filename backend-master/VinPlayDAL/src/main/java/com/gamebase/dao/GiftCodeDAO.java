 ...
 *  com.vinplay.vbee.common.models.SpecialGiftCode
...
public interface GiftCodeDAO {
    ...
    public JSONObject GetGiftCode(String var1);
    ...
    public boolean CheckSpecialGiftCodes(String var1);

    public GiftCodeUpdateResponse updateSpecialGiftCodeNew(String var1, String var2) throws SQLException;

    public boolean InsertSpecialGiftcode(SpecialGiftCode var1);

    public boolean UpdateSpecialGiftcode(SpecialGiftCode var1);

    public boolean DeleteSpecialGiftcode(String var1);

    public String GetGiftCodeByTypeNN(int var1, String var2);

    public List<SpecialGiftCode> GetSpecialGiftCodesByQuery(int var1, int var2, String var3, long var4, String var6, int var7);
}
