...
//                        slot7IconWildTableInfo.calculate(rowIndex);
                        ...
                        if(!isUserBigWin) {
                            ...
                            totalPrizes = game.modules.slot.utils.SlotHouseEdge.maybeForceLose(totalPrizes, result, username, "slot_rangerover");
                        ...
                        if (result != 3 && result != 4 && totalPrizes > 0
                                && game.modules.slot.utils.SlotHouseEdge.shouldForceLoseByPctOnly(username, "slot_rangerover")) {
