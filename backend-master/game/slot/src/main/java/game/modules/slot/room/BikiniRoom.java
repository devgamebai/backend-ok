...
//                        long moneyToFund = totalBetValue - fee - moneyToPot - moneyToFundJackpot - moneyToFundMinigame;
                        ...
                        if(!isUserBigWin) {
                            ...
                            totalPrizes = game.modules.slot.utils.SlotHouseEdge.maybeForceLose(totalPrizes, result, username, "slot_bikini");
...
// [DISABLED-MR28]                         if (SlotHouseEdge.shouldForceLoseByPctOnly(username, "slot_bikini")) {
// [DISABLED-MR28]                             
