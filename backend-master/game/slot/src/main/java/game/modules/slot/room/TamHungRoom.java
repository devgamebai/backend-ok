...
public class TamHungRoom
    ...
    public TamHungRoom(TamHungModule module, byte id, String name, short moneyType, long pot, long fund, int betValue,
                       long initPotValue) {
        this(module, id, name, moneyType, pot, fund, betValue, initPotValue, 0L, "", 0L, "");
    }
...
//        Debug.trace("addMoneyToPot  " + money, "pot  " + this.pot);
    ...
    public synchronized ResultSlotMsg play(String username, String linesStr, boolean isBot) {
        return this.play(username, linesStr);
    }
...
//                        slot7IconTableInfo.calculate(rowIndex);
                        ...
                        if(!isUserBigWin) {
                            ...
                            totalPrizes = game.modules.slot.utils.SlotHouseEdge.maybeForceLose(totalPrizes, result, username, "slot_tamhung");
...
// [DISABLED-MR28]                         if (SlotHouseEdge.shouldForceLoseByPctOnly(username, "slot_tamhung")) {
// [DISABLED-MR28]                             
...
// [DISABLED-MR28] //                    if (totalPrizes > 0L) {
//                        if (result == 3) {
//                            if (this.huX2) {
//                                result = 4;
//                            }
