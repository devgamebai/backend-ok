...
//                        slot11IconWildLienTucTableInfo.calculate(rowIndex);
                        ...
                        if(!isUserBigWin) {
                            ...
                            totalPrizes = game.modules.slot.utils.SlotHouseEdge.maybeForceLose(totalPrizes, result, username, "slot_benley");
...
// [DISABLED-MR28]                         if (SlotHouseEdge.shouldForceLoseByPctOnly(username, "slot_benley")) {
// [DISABLED-MR28]                             
