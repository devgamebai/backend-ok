        ...
        try {
            ...
            if (!this.isInitBot) {
                try {
                    ...
                    Debug.warn("error init bot galaxy");
                }
                this.isInitBot = true;
            }
            int moneyToJackPot_100 = GameConfig.getInstance().slotChiemtinhBotConfig.randomJackPotPer5s(0);
            GalaxyRoom room100 = (GalaxyRoom) this.galaxyModule.rooms.get(this.galaxyModule.gameName + "_vin_100");
            ...
            GalaxyRoom room1000 = (GalaxyRoom) this.galaxyModule.rooms.get(this.galaxyModule.gameName + "_vin_1000");
            ...
            GalaxyRoom room10000 = (GalaxyRoom) this.galaxyModule.rooms.get(this.galaxyModule.gameName + "_vin_10000");
            ...
            if (currentTime > timeJackPot_100) {
                ...
                room100.botEatJackpot(this.galaxyModule.keyBotJackpotGalaxy +
            ...
            if (currentTime > timeJackPot_1000) {
                ...
                room1000.botEatJackpot(this.galaxyModule.keyBotJackpotGalaxy +
            ...
            if (currentTime > timeJackPot_10000) {
                ...
                room10000.botEatJackpot(this.galaxyModule.keyBotJackpotGalaxy +
