...
public class BotJackPotDragonBallTimer implements Runnable {
    ...
    DragonBallModule dragonBallModule;

    public BotJackPotDragonBallTimer(long[] timeJackpot, DragonBallModule dragonBallModule) {
        this.timeJackPot_100 = timeJackpot[0];
        this.timeJackPot_1000 = timeJackpot[1];
        this.timeJackPot_10000 = timeJackpot[2];
        this.dragonBallModule = dragonBallModule;
    }
        ...
        try {
            ...
            if (!this.isInitBot) {
                try {
                    ...
                    Debug.warn("error init bot dragonball");
                }
                this.isInitBot = true;
            }
            int moneyToJackPot_100 = GameConfig.getInstance().slotChiemtinhBotConfig.randomJackPotPer5s(0);
            DragonBallRoom room100 = (DragonBallRoom) this.dragonBallModule.rooms.get(this.dragonBallModule.gameName + "_vin_100");
            ...
            DragonBallRoom room1000 = (DragonBallRoom) this.dragonBallModule.rooms.get(this.dragonBallModule.gameName + "_vin_1000");
            ...
            DragonBallRoom room10000 = (DragonBallRoom) this.dragonBallModule.rooms.get(this.dragonBallModule.gameName + "_vin_10000");
            ...
            if (currentTime > timeJackPot_100) {
                ...
                room100.botEatJackpot(this.dragonBallModule.keyBotJackpotDragonBall +
            ...
            if (currentTime > timeJackPot_1000) {
                ...
                room1000.botEatJackpot(this.dragonBallModule.keyBotJackpotDragonBall +
            ...
            if (currentTime > timeJackPot_10000) {
                ...
                room10000.botEatJackpot(this.dragonBallModule.keyBotJackpotDragonBall +
